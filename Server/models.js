...
const userSchema = new mongoose.Schema({
  nom: { type: String, maxlength: 20 },
  prenom: { type: String, maxlength: 30 },
  email: { type: String, required: true, unique: true, maxlength: 50 },
  password: { type: String, required: true },
  role: {
    type: String,
    enum: ['SUPERADMIN', 'ADMIN', 'OPERATEUR', 'CHAUFFEUR', 'CHEF_PARK'],
    required: true,
  },
...
const Associer = sequelize.define('Associer', {
    id: {
        type: DataTypes.INTEGER,
        primaryKey: true,
        autoIncrement: true,
...
}, { tableName: 'panne', timestamps: false });
const Permis = sequelize.define("Permis", {
    ...
    type: {
        type: DataTypes.ENUM('A1', 'A', 'B', 'B+E', 'C', 'C+E', 'D', 'D+E', 'D1', 'H'),
        allowNull: false
    },
    date: {
        type: DataTypes.DATE,
...
}, { tableName: 'permis', timestamps: false });
